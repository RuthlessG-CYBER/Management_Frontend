...
function Home() {
    ...
    const [selected, setSelected] = useState<"home" | "products" | "orders" | "dashboard">("home");
            ...
            {selected === "products" && (
                <main className="grow w-full">
                    <div className="flex items-center justify-between px-5 mt-3">
                        ...
                        <Button variant="outline" className="bg-black text-white hover:text-black hover:bg-white " onClick={() => setOpenAdd(true)}>
                            <BadgePlus />
